    ...
    <div class="row">
      ...
      <div class="main col-xs-12 pad0">
        ...
        <div class="col-xs-12 pad0 chat_part mod pt7">
          ...
          <swiper id="swiper3" class="col-xs-12 pad0 swiper-container chat_con mod_con swiper3 mt33" :options="chatOption">
        ...
        <div class="col-xs-12 pad0 mod pt7 case_part mt44">
          ...
          <swiper id="swiper5" class="col-xs-12 pad0 swiper-container mod_con case_con swiper5 mt33" :options="caseOption">
          ...
          <div v-for="hotarr in hotarrs" class="col-xs-12 hot_con">
            ...
            <router-link :to="{name:'hotact',params:{id:hotarr.id}}">
              ...
              <div class="hot_int fr">
                ...
                <span v-else-if="hotarr.starttime<=gettime && hotarr.endtime>gettime" class="hot_sta doing_state">进行中</span>
                      ...
                      <div class="boxsize site_det clearfix">
                        <div class="site_inf ft24 pull-left">
                          ...
                          <h5 class="site_tit clearfix">
                            ...
                            <p class="pull-left"><span class="pull-left">装修预算：</span><em class="pull-left ">{{ sitearr.price }}万</em></p></h5>
                          <p class="clearfix mt20 site_con2">
                            <span class="pull-left ft20 site_hint">{{ sitearr.stage }}</span>
                            <span class="pull-left ml12">面积：</span><em class="pull-left pr12 bor">{{ sitearr.area }}m<sup>2</sup></em>
